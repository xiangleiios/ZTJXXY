...
- (void)loadsubview{
    ...
    [v mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(lbTitle.mas_bottom).mas_offset(KFit_H6S(80));
        make.left.mas_equalTo(self.view).mas_offset(KFit_W6S(30));
...
//    [v addSubview:imgpho];
    self.pho=[[TKPhoneTextField alloc]initWithFrame:CGRectMake(0, 0, KFit_W6S(400), viewHight)];
    ...
    self.verificationCode=[[UITextField alloc]initWithFrame:CGRectMake(0, viewHight, KFit_W6S(400), viewHight)];
...
//    [v addSubview:imgCompany];
    self.password=[[UITextField alloc]initWithFrame:CGRectMake(0, viewHight * 2, KFit_W6S(550), viewHight)];
    self.password.font=[UIFont systemFontOfSize:kFit_Font6(15)];
    [v addSubview:self.password];
    self.password.placeholder=@"请输入包含数字和字母的6-11位密码";
...
//    [v addSubview:imgpass];
    self.passwordtwo=[[UITextField alloc]initWithFrame:CGRectMake(0, viewHight * 3, KFit_W6S(450), viewHight)];
...
- (void)loadfunctionbut{
    ...
    [but mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.passwordtwo.mas_bottom).mas_offset(KFit_H6S(40));
    ...
    but.backgroundColor = kColor_N(0, 105, 234);
