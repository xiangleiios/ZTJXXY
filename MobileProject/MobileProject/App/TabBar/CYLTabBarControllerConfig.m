...
//        [firstNavigationController.navigationBar setTintColor:kWhiteColor];
        ...
        //试题
        QuestionRootVC * secondViewController = [[QuestionRootVC alloc] init];
        ...
        NSArray * viewControllers = @[firstNavigationController,secondNavigationController,fourthNavigationController];
...
- (NSArray *)tabBarItemsAttributes {
    ...
    NSDictionary * tabBarItemAttribute03 = @{
     ...
     NSArray * tarBarItemsAttrbutes = @[tabBarItem1Attribute01,tabBarItemAttribute02,tabBarItemAttribute03];
